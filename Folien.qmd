...
- Man kann Gradient/Ableitung automatisch erhalten kann<br>
...
::: {.panel-tabset}
### Tab 1
Ein kurzer Vergleich der Stärken von CPU und GPUs.
...
::: {.panel-tabset}
### Tab 1
In PyTorch lassen sich eigene Datensätze über Klassen generieren. Ein Beispiel Use Case könnte zum Beispiel so lauten.
